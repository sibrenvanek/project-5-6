namespace EFFY.Migrations
{
    ...
    public partial class SupplierFKS : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Inernal hard disk", t => t.InternalHDD_InternalHDDId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.user", "InternalHDD_InternalHDDId", "dbo.Inernal hard disk");
            DropForeignKey("dbo.Inernal hard disk", "SupplierId", "dbo.Supplier");
            DropForeignKey("dbo.Product", "InternalHDD_InternalHDDId", "dbo.Inernal hard disk");
            DropForeignKey("dbo.Inernal hard disk", "ProductId", "dbo.Product");
            ...
            DropIndex("dbo.Inernal hard disk", new[] { "SupplierId" });
            DropIndex("dbo.Inernal hard disk", new[] { "ProductId" });
